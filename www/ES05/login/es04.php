<!-- http://204.216.213.176/inf3php/ES05/login/es04.php -->
<!DOCTYPE html>
<html lang="it">
<head>
    <meta charset="UTF-8">
        ...
        <form class="space-y-6" action="login_process.php" method="POST" id="loginForm">
            ...
            <div class="relative">
                <input 
                    ...
                    type="email" 
                    required 
                    class="w-full px-3 pt-6 pb-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 peer"
                    value="filippo.bilardo@tiscali.it"
                >
                <label for="email" class="absolute left-3 top-2 text-xs text-gray-500 transition-all pointer-events-none">E-mail</label>
            </div>
            ...
            <div class="relative">
                <input 
                    ...
                    type="password"
                    required 
                    class="w-full px-3 pt-6 pb-2 pr-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 peer"
                    value="........"
                >
                <label for="password" class="absolute left-3 top-2 text-xs text-gray-500 transition-all pointer-events-none">Password</label>
                <button 
                    type="button" 
